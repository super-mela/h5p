...
const SummarySlide = (function () {
   ...
   * @param {H5P.GreslernPresentation} greslernPresentation Greslern presentation parent of summary slide
   * @param {$} $summarySlide Summary slide element
   * @constructor
   */
  function SummarySlide(greslernPresentation, $summarySlide) {
    // Create summary slide if not an editor
    this.$summarySlide = $summarySlide;
    this.cp = greslernPresentation;
  }
