H5PEditor.GreslernPresentation.BackgroundSelector = (function ($, EventDispatcher) {

  /**
   * Create a Background Selector.
   *
   * @class H5PEditor.GreslernPresentation.BackgroundSelector
  ...
  function BackgroundSelector($backgroundSlides, isSingleSlide) {
    ...
    var radioLabels = [
      H5PEditor.t('H5PEditor.GreslernPresentation', 'setImageBackground', {}),
      H5PEditor.t('H5PEditor.GreslernPresentation', 'setColorFillBackground', {})
    ];
     ...
     * @returns {H5PEditor.GreslernPresentation.BackgroundSelector}
     */
    self.addResetButton = function (text) {
      text = text || H5PEditor.t('H5PEditor.GreslernPresentation', 'resetToDefault');
