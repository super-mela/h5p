 ...
 */
H5PEditor.GreslernPresentation = function (parent, field, params, setValue) {
  var that = this;
  ...
  parent.ready(function () {
    ...
    activeSurfaceCheckbox.on('checked', function () {
      ...
      that.cp.$wrapper.addClass('h5p-greslern-presentation-active-surface');
      ...
      that.slideRatio = H5PEditor.GreslernPresentation.RATIO_SURFACE;
...
H5PEditor.GreslernPresentation.prototype = Object.create(H5P.DragNBar.FormManager.prototype);
H5PEditor.GreslernPresentation.prototype.constructor = H5PEditor.GreslernPresentation;

/**
 * Must be changed if the semantics for the elements changes.
 * @type {string}
 */
H5PEditor.GreslernPresentation.clipboardKey = 'H5PEditor.GreslernPresentation';
 ...
 */
H5PEditor.GreslernPresentation.prototype.updateElementSizes = function (heightRatio) {
 ...
 * @returns {object}
 */
H5PEditor.GreslernPresentation.prototype.addElement = function (library, options) {
  options = options || {};
  var elementParams;
 ...
 * @returns {undefined}
 */
H5PEditor.GreslernPresentation.prototype.appendTo = function ($wrapper) {
  var that = this;
  ...
  if (presentationParams && presentationParams.override && presentationParams.override.activeSurface === true) {
    this.slideRatio = H5PEditor.GreslernPresentation.RATIO_SURFACE;
  }
  this.cp = new H5P.GreslernPresentation(presentationParams, H5PEditor.contentId, { cpEditor: this });
  ...
  var globalBackgroundField = H5PEditor.GreslernPresentation.findField('globalBackgroundSelector', this.field.fields);
  var slideFields = H5PEditor.GreslernPresentation.findField('slides', this.field.fields);
  this.backgroundSelector = new H5PEditor.GreslernPresentation.SlideSelector(that, that.cp.$slidesWrapper, globalBackgroundField, slideFields, that.params)
    .appendTo($settingsWrapper);

  // Add and bind slide controls.
  var slideControls = {
    $add: H5PEditor.$('<a href="#" aria-label="' + H5PEditor.t('H5PEditor.GreslernPresentation', 'newSlide') + '" class="h5p-slidecontrols-button h5p-slidecontrols-button-add"></a>'),
    $clone: H5PEditor.$('<a href="#" aria-label="' + H5PEditor.t('H5PEditor.GreslernPresentation', 'cloneSlide') + '" class="h5p-clone-slide h5p-slidecontrols-button h5p-slidecontrols-button-clone"></a>'),
    $background: H5PEditor.$('<a href="#" aria-label="' + H5PEditor.t('H5PEditor.GreslernPresentation', 'backgroundSlide') + '" class="h5p-slidecontrols-button h5p-slidecontrols-button-background"></a>'),
    $sortLeft: H5PEditor.$('<a href="#" aria-label="' + H5PEditor.t('H5PEditor.GreslernPresentation', 'sortSlide', { ':dir': 'left' }) + '" class="h5p-slidecontrols-button h5p-slidecontrols-button-sort-left"></a>'),
    $sortRight: H5PEditor.$('<a href="#" aria-label="' + H5PEditor.t('H5PEditor.GreslernPresentation', 'sortSlide', { ':dir': 'right' }) + '" class="h5p-slidecontrols-button h5p-slidecontrols-button-sort-right"></a>'),
    $delete: H5PEditor.$('<a href="#" aria-label="' + H5PEditor.t('H5PEditor.GreslernPresentation', 'removeSlide') + '" class="h5p-slidecontrols-button h5p-slidecontrols-button-delete"></a>')
  };
 ...
 */
H5PEditor.GreslernPresentation.prototype.resetSubContentId = function (params) {
  const that = this;
 ...
 */
H5PEditor.GreslernPresentation.prototype.addDNBButton = function (library, options) {
  var that = this;
  options = options || {};
 ...
 */
H5PEditor.GreslernPresentation.prototype.addDNBButtonGroup = function (library, groupData) {
  var that = this;
  var id = library.name.split('.')[1].toLowerCase();
...
H5PEditor.GreslernPresentation.prototype.setContainerEm = function (containerEm) {
 ...
 * @returns {undefined}
 */
H5PEditor.GreslernPresentation.prototype.initializeDNB = function () {
  var that = this;

  this.$bar = H5PEditor.$('<div class="h5p-dragnbar">' + H5PEditor.t('H5PEditor.GreslernPresentation', 'loading') + '</div>').insertBefore(this.cp.$boxWrapper);
  var slides = H5PEditor.GreslernPresentation.findField('slides', this.field.fields);
  var elementFields = H5PEditor.GreslernPresentation.findField('elements', slides.field.fields).field.fields;
  var action = H5PEditor.GreslernPresentation.findField('action', elementFields);
  ...
  H5PEditor.LibraryListCache.getLibraries(action.options, function (libraries) {
    ...
    var goToSlide = H5PEditor.GreslernPresentation.findField('goToSlide', elementFields);
    if (goToSlide) {
      buttons.splice(5, 0, {
        id: 'gotoslide',
        title: H5PEditor.t('H5PEditor.GreslernPresentation', 'goToSlide'),
        createElement: function () {
    ...
    that.dnb.on('paste', function (event) {
      ...
      if (pasted.from === H5PEditor.GreslernPresentation.clipboardKey) {
 ...
 */
H5PEditor.GreslernPresentation.prototype.canPaste = function (clipboard) {
  if (clipboard) {
    if (clipboard.from === H5PEditor.GreslernPresentation.clipboardKey &&
 ...
 */
H5PEditor.GreslernPresentation.prototype.createHtml = function () {
 ...
 */
H5PEditor.GreslernPresentation.prototype.validate = function () {
 ...
 * Remove this item.
 */
H5PEditor.GreslernPresentation.prototype.remove = function () {
  this.trigger('remove');
 ...
 */
H5PEditor.GreslernPresentation.prototype.initKeywordInteractions = function () {
  var that = this;
  ...
  that.$keywordsDNB = H5PEditor.$(
    ...
    '<div title="' + H5PEditor.t('H5PEditor.GreslernPresentation', 'slides') + '" class="h5p-dragnbar-keywords" role="button" tabindex="0">' +
    '<span>' + H5PEditor.t('H5PEditor.GreslernPresentation', 'slides') + '</span>' +
    '</div>' +
    '<div class="h5p-keywords-dropdown">' +
    '<label class="h5p-keywords-enable">' +
    '<input type="checkbox"/>' +
    H5PEditor.t('H5PEditor.GreslernPresentation', 'showTitles') +
    '</label>' +
    '<label class="h5p-keywords-always"><input type="checkbox"/>' + H5PEditor.t('H5PEditor.GreslernPresentation', 'alwaysShow') + '</label>' +
    '<label class="h5p-keywords-hide"><input type="checkbox"/>' + H5PEditor.t('H5PEditor.GreslernPresentation', 'autoHide') + '</label>' +
    '<label class="h5p-keywords-opacity"><input type="text"/> % ' + H5PEditor.t('H5PEditor.GreslernPresentation', 'opacity') + '</label>' +
    '<div class="h5peditor-button h5peditor-button-textual importance-low" role="button" tabindex="0" aria-disabled="false">' +
    H5PEditor.t('H5PEditor.GreslernPresentation', 'ok') +
    '</div>' +
    '</div>' +
    '</li>' +
 ...
 */
H5PEditor.GreslernPresentation.prototype.initKeywordMenu = function () {
  var that = this;
  // Keyword events
 ...
 * @returns {undefined} Nothing
 */
H5PEditor.GreslernPresentation.prototype.addSlide = function (slideParams) {
  var that = this;
...
H5PEditor.GreslernPresentation.prototype.updateNavigationLine = function (index) {
  var that = this;
 ...
 */
H5PEditor.GreslernPresentation.prototype.removeSlide = function () {
  ...
  //   headerText: H5PEditor.t('H5PEditor.GreslernPresentation', 'confirmDeleteSlide'),
 ...
 */
H5PEditor.GreslernPresentation.prototype.animateNavigationLine = function (direction) {
  var that = this;
 ...
 */
H5PEditor.GreslernPresentation.prototype.updateSlidesSidebar = function () {
  var self = this;
  ...
  $keywords.each(function (index) {
    ...
    var $editIcon = H5PEditor.$(
      '<a href="#" class="joubel-icon-edit h5p-hidden" title="' + H5PEditor.t('H5PEditor.GreslernPresentation', 'edit') + '" tabindex="0">' +
 ...
 * @returns {Boolean} Indicates success.
 */
H5PEditor.GreslernPresentation.prototype.sortSlide = function ($element, direction) {
  if (!$element.length) {
    return false;
  }
 ...
 */
H5PEditor.GreslernPresentation.prototype.swapCollectionIndex = function (collection, firstIndex, secondIndex) {
 ...
 * @param {jQuery} $other
 */
H5PEditor.GreslernPresentation.prototype.swapIndexes = function ($current, $other) {
 ...
 */
H5PEditor.GreslernPresentation.prototype.editKeyword = function ($span) {
  var that = this;
  ...
  var $delete = H5PEditor.$(
    '<a href="#" class="joubel-icon-cancel" title="' + H5PEditor.t('H5PEditor.GreslernPresentation', 'cancel') + '">' +
    '<span class="h5p-icon-circle"></span>' +
 ...
 */
H5PEditor.GreslernPresentation.prototype.updateKeyword = function (keyword, slideIndex, oldTitle) {
  var that = this;
  var hasTitle = true;
 ...
 * @returns {Object}
 */
H5PEditor.GreslernPresentation.prototype.generateForm = function (elementParams, type) {
  var self = this;
  ...
  var slides = H5PEditor.GreslernPresentation.findField('slides', this.field.fields);
  var elementFields = H5PEditor.$.extend(true, [], H5PEditor.GreslernPresentation.findField('elements', slides.field.fields).field.fields);
  ...
  if (!(library instanceof H5PEditor.None)) {
    var libraryChange = function () {
      ...
      var libraryOptions = H5PEditor.GreslernPresentation.findField('action', elementFields).options;
 ...
 */
H5PEditor.GreslernPresentation.prototype.setImageSize = function (element, elementParams, fileParams) {
 ...
 * @param {object} fileParams
 */
H5PEditor.GreslernPresentation.prototype.setVideoSize = function (elementParams, fileParams) {
  if (!fileParams) {
    return;
  }
 ...
 * @param {String[]} fields
 */
H5PEditor.GreslernPresentation.prototype.hideFields = function (elementFields, fields) {
  // Find and hide fields in list
  for (var i = 0; i < fields.length; i++) {
    var field = H5PEditor.GreslernPresentation.findField(fields[i], elementFields);
    if (field) {
      field.widget = 'none';
    }
  }
 ...
 * @param {String[]} fields
 */
H5PEditor.GreslernPresentation.prototype.showFields = function (elementFields, fields) {
...
*/
H5PEditor.GreslernPresentation.prototype.findLibraryTitle = function (library, next) {
  var self = this;
 ...
 * @returns {undefined}
 */
H5PEditor.GreslernPresentation.prototype.processElement = function (elementParams, $wrapper, slideIndex, elementInstance) {
  var that = this;
 ...
 */
H5PEditor.GreslernPresentation.prototype.addToDragNBar = function (element, elementParams) {
  var self = this;
  ...
  var clipboardData = H5P.DragNBar.clipboardify(H5PEditor.GreslernPresentation.clipboardKey, elementParams, 'action');
 ...
 * @returns {undefined}
 */
H5PEditor.GreslernPresentation.prototype.removeElement = function (element, $wrapper, isContinuousText) {
  var slideIndex = this.cp.$current.index();
  var elementIndex = $wrapper.index();
 ...
 * @returns {undefined}
 */
H5PEditor.GreslernPresentation.prototype.showElementForm = function (element, $wrapper, elementParams) {
  var that = this;
  ...
  var focusFirstField = function () {
    ...
    if (libraryField.$myField === undefined) {
      H5P.jQuery('.h5p-greslernpresentation-editor .form-manager-slidein .h5peditor-text')
        .eq(0)
        .focus();
    }
  };
  ...
  if (elementParams.action === undefined) {
    customTitle = H5PEditor.t('H5PEditor.GreslernPresentation', 'goToSlide');
...
*/
H5PEditor.GreslernPresentation.prototype.redrawElement = function ($wrapper, element, elementParams, repeat) {
  var elementIndex = $wrapper.index();
  var slideIndex = this.cp.$current.index();
 ...
 * @param {Object} elementParams
 */
H5PEditor.GreslernPresentation.prototype.fitElement = function ($element, elementParams) {
  var self = this;
...
*/
H5PEditor.GreslernPresentation.prototype.getCTs = function (firstOnly, maxTwo) {
  var self = this;
 ...
 * @returns {undefined}
 */
H5PEditor.GreslernPresentation.prototype.ready = function (ready) {
  if (this.passReadies) {
 ...
 */
H5PEditor.GreslernPresentation.findField = function (name, fields) {
  for (var i = 0; i < fields.length; i++) {
 ...
 */
H5PEditor.GreslernPresentation.prototype.showConfirmationDialog = function (dialogOptions) {
...
/** @constant {Number} */
H5PEditor.GreslernPresentation.RATIO_SURFACE = 16 / 9;


// Tell the editor what widget we are.
H5PEditor.widgets.greslernpresentation = H5PEditor.GreslernPresentation;
