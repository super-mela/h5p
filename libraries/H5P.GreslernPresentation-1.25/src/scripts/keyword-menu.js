...
export default class KeywordMenu {
   ...
   */
  constructor({ l10n, currentIndex, children }) {
    this.l10n = l10n;
   ...
   */
  init(keywordConfigs) {
    this.menuItemElements = keywordConfigs.map((config, i) => this.createMenuItemElement(config, i));
   ...
   * @return {Element}
   */
  createMenuItemElement(config, i) {
    ...
    this.applyConfigToMenuItemElement(element, config, i);
