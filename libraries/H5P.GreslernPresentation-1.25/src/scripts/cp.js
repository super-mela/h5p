 ...
 */
let GreslernPresentation = function (params, id, extras) {
  var that = this;
...
GreslernPresentation.prototype = Object.create(Parent.prototype);
GreslernPresentation.prototype.constructor = GreslernPresentation;

/**
 * @public
 * @return {object}
 */
GreslernPresentation.prototype.getCurrentState = function () {
 ...
 * @return {boolean}
 */
GreslernPresentation.prototype.slideHasAnsweredTask = function (index) {
 ...
 * @returns {undefined} Nothing.
 */
GreslernPresentation.prototype.attach = function ($container) {
  var that = this;
  ...
  $container
    ...
    .addClass('h5p-greslern-presentation')
    .html(html);
  ...
  if (this.activeSurface) {
    this.$wrapper.addClass('h5p-greslern-presentation-active-surface');
  }
 ...
 */
GreslernPresentation.prototype.belongsToTagName = function (node, tagNames, stop) {
  if (!node) {
    return false;
  }
 ...
 */
GreslernPresentation.prototype.hasTabIndex = (element, stopElement) => {
 ...
 * @return {jQuery}
 */
GreslernPresentation.prototype.updateKeywordMenuFromSlides = function () {
 ...
 */
GreslernPresentation.prototype.getKeywordMenuConfig = function () {
  return this.slides
    .map((slide, index) => ({
 ...
 * @return {string|null}
 */
GreslernPresentation.prototype.createSlideTitle = function (slide) {
 ...
 * @return {boolean}
 */
GreslernPresentation.prototype.isEditor = function () {
 ...
 * @return {boolean}
 */
GreslernPresentation.prototype.hasKeywords = function (slide) {
 ...
 */
GreslernPresentation.prototype.createSlides = function () {
  var self = this;
 ...
 * @returns {boolean}
 */
GreslernPresentation.prototype.hasScoreData = function (obj) {
  return (
 ...
 * @returns {Number}
 */
GreslernPresentation.prototype.getScore = function () {
  var self = this;
 ...
 * @returns {Number}
 */
GreslernPresentation.prototype.getMaxScore = function () {
  var self = this;
 ...
 */
GreslernPresentation.prototype.setProgressBarFeedback = function (slideScores) {
 ...
 */
GreslernPresentation.prototype.toggleKeywords = function () {
 ...
 * Hide keywords
 */
GreslernPresentation.prototype.hideKeywords = function () {
 ...
 * Show keywords
 */
GreslernPresentation.prototype.showKeywords = function () {
  if (this.$keywordsWrapper.hasClass('h5p-open')) {
    // Already showing
    return;
  }
 ...
 */
GreslernPresentation.prototype.setKeywordsOpacity = function (value) {
 ...
 * @returns {undefined}
 */
GreslernPresentation.prototype.fitCT = function () {
 ...
 * @returns {undefined}
 */
GreslernPresentation.prototype.resize = function () {
 ...
 */
GreslernPresentation.prototype.toggleFullScreen = function () {
 ...
 * Set focus.
 */
GreslernPresentation.prototype.focus = function () {
  this.$wrapper.focus();
};
 ...
 * @param {number} index
 */
GreslernPresentation.prototype.keywordClick = function (index) {
...
GreslernPresentation.prototype.shouldHideKeywordsAfterSelect = function () {
 ...
 */
GreslernPresentation.prototype.setElementsOverride = function (override) {
 ...
 * @param {Number} index
 */
GreslernPresentation.prototype.attachElements = function ($slide, index) {
 ...
 */
GreslernPresentation.prototype.disableTabIndexes = function () {
 ...
 */
GreslernPresentation.prototype.restoreTabIndexes = function () {
  if (this.$tabbables) {
 ...
 * @return {jQuery}
 */
GreslernPresentation.prototype.createInteractionButton = function (element, instance) {
 ...
 */
GreslernPresentation.prototype.showInteractionPopup = function (instance, $button, $buttonElement, libTypePmz, closeCallback, popupPosition = null) {
 ...
 * @return {string}
 */
GreslernPresentation.prototype.getLibraryTypePmz = library => kebabCase(library.split(' ')[0]).toLowerCase();
 ...
 */
GreslernPresentation.prototype.resizePopupImage = function ($wrapper) {
 ...
 */
GreslernPresentation.prototype.addElementSolutionButton = function (element, elementInstance, $elementContainer) {
 ...
 */
GreslernPresentation.prototype.showPopup = function ({
  popupContent,
  $focusOnClose,
  parentPosition = null,
  remove,
 ...
 *  false otherwise
 */
GreslernPresentation.prototype.checkForSolutions = function (elementInstance) {
 ...
 * @returns {undefined} Nothing.
 */
GreslernPresentation.prototype.initKeyEvents = function () {
 ...
 * @returns {undefined} Nothing.
 */
GreslernPresentation.prototype.initTouchEvents = function () {
  var that = this;
 ...
 * @param yPos
 */
GreslernPresentation.prototype.updateTouchPopup = function ($container, slideNumber, xPos, yPos) {
 ...
 */
GreslernPresentation.prototype.previousSlide = function (noScroll, old = true) {
 ...
 * @returns {Boolean} Indicates if the move was made.
 */
GreslernPresentation.prototype.nextSlide = function (noScroll, old = true) {
 ...
 * @return {boolean}
 */
GreslernPresentation.prototype.isCurrentSlide = function (index) {
 ...
 * @return {number}
 */
GreslernPresentation.prototype.getCurrentSlideIndex = function () {
 ...
 */
GreslernPresentation.prototype.processJumpToSlide = function (slideNumber, noScroll, handleFocus) {
  var that = this;
  ...
  // // Get the element and extract left and top styles
  // var element = this.$current.find('.h5p-element-button-big')[0];
  // var leftStyle = element.style.left;
  // var topStyle = element.style.top;

  // // Parse the percentage values to numbers
  // var leftPercentage = parseFloat(leftStyle);
  // var topPercentage = parseFloat(topStyle);

  // // Calculate dynamic translate3d values based on left and top positions
  // var translateX = (leftPercentage - 50) * 2; // Adjust as needed
  // var translateY = (topPercentage - 50) * 2; // Adjust as needed
  ...
  // setTimeout(function () {
  //   $slides.css({
  //     '-webkit-transform': 'scale(1.2) translate3d(' + translateX + 'px, ' + translateY + 'px, 0)',
  //     '-moz-transform': 'scale(1.2) translate3d(' + translateX + 'px, ' + translateY + 'px, 0)',
  //     '-ms-transform': 'scale(1.2) translate3d(' + translateX + 'px, ' + translateY + 'px, 0)',
  //     'transform': 'scale(1.2) translate3d(' + translateX + 'px, ' + translateY + 'px, 0)'
  //   });
  // }, 250)
 ...
 * @returns {Boolean}
 */
GreslernPresentation.prototype.jumpToSlide = function (slideNumber, noScroll = false, callback = null, handleFocus = false, ignoreConfirmationDialog = false) {
  if (this.standalone
 ...
 */
GreslernPresentation.prototype.setOverflowTabIndex = function () {
 ...
 */
GreslernPresentation.prototype.setSlideNumberAnnouncer = function (slideNumber, handleFocus = false) {
  let slideTitle = '';
 ...
 */
GreslernPresentation.prototype.resetTask = function (moveFocus = false) {
 ...
 * @returns {undefined}
 */
GreslernPresentation.prototype.showSolutions = function () {
    ...
    if (this.slidesWithSolutions[i] !== undefined) {
      ...
      for (var j = 0; j < this.slidesWithSolutions[i].length; j++) {
        ...
        if (elementInstance.getMaxScore !== undefined) {
          ...
          hasScores = true;
          indexes.push(elementInstance.greslernPresentationIndexOnSlide);
        }
      }
      slideScores.push({
        indexes: indexes,
 ...
 */
GreslernPresentation.prototype.getSlideScores = function (noJump) {
 ...
 */
GreslernPresentation.prototype.getCopyrights = function () {
 ...
 */
GreslernPresentation.prototype.getXAPIData = function () {
 ...
 */
GreslernPresentation.prototype.getContext = function () {
  var self = this;
...
export default GreslernPresentation;
